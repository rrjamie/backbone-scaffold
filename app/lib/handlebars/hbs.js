...
/**
 * Slightly modified to work with lodash (instead of underscore)
 */
        ...
        load: function (name, parentRequire, load, config) {
          //>>excludeStart('excludeHbs', pragmas.excludeHbs)
            ...
            function getExternalDeps( nodes ) {
              ...
              return {
                vars : _.map(_.unique(res), function(e){
                  if ( e === "" ) {
                    return '.';
                  }
                ...
                helpers : _.compact(_.map(_.unique(helpersres), function(e){
